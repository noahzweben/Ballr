...
Why did the Ballr garbage collector refuse to go to the team offsite?

It heard there would be icebreakers, and it only knows how to break references nobody else is holding. 🗑️
