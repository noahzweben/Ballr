...
Why are the `fail-*.blr` tests the happiest files in the repo?

Because they're the only ones whose entire job is to fail — and `testall.sh` marks it a SUCCESS every single time. 🎯
