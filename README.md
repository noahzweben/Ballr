...
Why did the Ballr garbage collector get promoted to team lead?

Because it knows exactly which references nobody is using anymore, and it cleans them up without calling a meeting first. 🗑️
