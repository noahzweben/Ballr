...
Why does `testall.log` never get invited to retrospectives?

It remembers every failure in the repo's history — and it's committed to bringing all of them up. 📜
