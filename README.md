...
Why do Ballr source files end in `.blr` instead of `.ballr`?

Because the vowels got optimized away — LLVM saw three of them and filed it under "dead code elimination." 🔤
