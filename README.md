...
Why does `testall.log` know all of the team's secrets?

Because it was there for every single failure — and unlike the developers, it actually wrote them down. 📜
