...
Why did `testall.log` get committed to the repo?

Because it wanted every failure it ever witnessed on the permanent record — complete with history and `git blame`. 📜
