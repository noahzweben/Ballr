...
Why did `pong.blr` drop out of therapy?

Every time the therapist raised an issue, it just bounced it straight back — and it has been doing that sixty frames a second since 1972. 🏓
