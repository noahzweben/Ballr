...
define i32 @main() #0 {
  ...
  store %struct.gameboard* %5, %struct.gameboard** %1, align 8
  %6 = bitcast %struct.blr_size* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* bitcast (%struct.blr_size* @main.main_size to i8*), i64 8, i32 4, i1 false)
  %7 = bitcast %struct.blr_color* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %7, i8* bitcast (%struct.blr_color* @main.main_clr to i8*), i64 12, i32 4, i1 false)
  %8 = load %struct.gameboard*, %struct.gameboard** %1, align 8
  call void @gb_init(%struct.gameboard* %8, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i32 0, i32 0), %struct.blr_size* %2, %struct.blr_color* %3, void (%struct.gameboard*)* @game1_init)
  %9 = call i32 (...) @run_loop()
  ret i32 0
}
...
declare void @gb_init(%struct.gameboard*, i8*, %struct.blr_size*, %struct.blr_color*, void (%struct.gameboard*)*) #1
